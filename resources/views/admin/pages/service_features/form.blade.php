<form id="form-request-service-features">
    <div class="modal-body">
        ...
        <div class="form-group mb-3">
            <label for="icon" class="col-sm-12">Ícone (FontAwesome):</label>
            <div class="col-sm-12">
                <input type="text" class="form-control" id="icon" name="icon" placeholder="Ex: fas fa-utensils" value="{{ isset($result->icon) ? $result->icon : '' }}">
            </div>
        </div>
        <div class="form-group mb-3">
    ...
    <div class="bg-gray modal-footer justify-content-between">
        <button type="button" class="btn btn-success button-service-features-save"><i class="fa fa-check"></i> Salvar</button>
